                                ...
                                <ul class="navbar-nav">
                                 ...
                                 <!-- Dropdown -->
									<li class="nav-item dropdown">
									  <a class="nav-link dropdown-toggle"  href=<?php echo $level.PAGE."phone.php"?> id="navbardrop" data-toggle="dropdown">
										Điện thoại
									  </a>
									...
									<!-- Dropdown -->
									<li class="nav-item dropdown">
										<a class="nav-link dropdown-toggle"  style="text-decoration: none;" href=<?php echo $level.PAGE."Tablet.php"?>  id="navbardrop" data-toggle="dropdown">
										Máy tính bảng 
										</a>
										<div class="dropdown-menu">
