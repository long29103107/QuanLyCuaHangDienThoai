<?php
	...
	$id = $_GET['id'];
	include($level.Content."data-suatintuc.php");
?>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		...
		<div class="container">
			<div class="row">
				...
				<form action="<?php echo $level.Content."sua-data-suatintuc"; ?>" method="get">	
						<div class="row">
							<div class="col-2">Tiêu đề</div>
							<div class="col-10">
								<div class="form-group">
									<input type="text" class="form-control" name="txttieude" value="<?php echo $tintuc[0]['tieude'];?>">
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="form-group col-10">
							  <textarea class="form-control" rows="5" name="txtnoidung" id="comment"><?php echo $tintuc[0]['noidung'];?></textarea>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-2 offset-5">
								<input type = "hidden" value= "<?php echo $tintuc[0]['idchuyenmuc']; ?>" name="idchuyenmuc">
